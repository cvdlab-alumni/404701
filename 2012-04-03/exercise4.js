...
var gambaSedia1=T([0,1])([0.7,0.45])(SIMPLEX_GRID([[0.1],[0.1],[0.5]]));
var gambaSedia2=T([0,1])([0.2,0.45])(SIMPLEX_GRID([[0.1],[0.1],[0.5]]));
var appoggio=T([2])([0+0.5])(SIMPLEX_GRID([[1],[1],[0.05]]));
var sedia=STRUCT([appoggio,gambaSedia1,gambaSedia2]);
//posiziona una sedia nella stanza in alto a sinistra
...
var Barcellonapavilion = STRUCT([pavimento, piscine, scala, muroPanchina, muroPiscinaPiccola, muroPiscinaGrande, altriMuri, vetri,tetti,pilastri,panchina,sedia]);
